...
class SyncArrival(AtomicBehavior):
    ...
    def update(self):
        ...
        """
        print(f"SyncArrival: actor:{self._actor.id}, reference_actor:{self._actor_reference.id}, "
                f"target_location:{self._target_location}, gain:{self._gain}")
        new_status = py_trees.common.Status.RUNNING
        ...
        print(f"SyncArrival: distance_reference:{distance_reference}, distance:{distance}, "
                f"velocity_reference:{velocity_reference}, time_reference:{time_reference}, "
                f"velocity_current:{velocity_current}, time_current:{time_current}")
        ...
        print(f"SyncArrival: control_value:{control_value}, throttle:{self._control.throttle}, "
                f"brake:{self._control.brake}")
...
class SyncArrivalWaypointFollower(AtomicBehavior):
