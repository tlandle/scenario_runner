...
"""
This is a set of ecloud project scenarios
"""
...
def get_opponent_transform(added_dist, waypoint, trigger_location):
    ...
    offset = {"orientation": 180, "position": 90, "k": -1.0}
...
class eCloudVehicleTurningRight(BasicScenario):

    """
    This is an initial attempt at a basic scenario for an ego vehicle turning right at a junction so that
    we can explore edge-vehicle communication and how this improves decision making.
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        print(self._reference_waypoint)
        ...
        self._ego_route = CarlaDataProvider.get_ego_vehicle_route() # Need to explore this - how can we pass in a route?

        super(eCloudVehicleTurningRight, self).__init__("eCloudVehicleTurningRight",
                                                  ego_vehicles,
                                                  config,
                                                  world,
                                                  debug_mode,
...
class eCloudVehicleTurningRoute(BasicScenario):
